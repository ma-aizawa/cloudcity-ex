...
function monitor_diary_comment_list4c_member_id($c_member_id, $page_size, $page)
{
    $page = intval($page);
    $page_size = intval($page_size);

    $where = " WHERE c_diary_comment.c_member_id = ? ";
...
function monitor_topic_comment_list4c_member_id($c_member_id, $page_size, $page)
{
    $page = intval($page);
    $page_size = intval($page_size);

    $where = " WHERE ctc.number <> 0 AND ctc.c_member_id = ? ";
    $params[] = intval($c_member_id);
