...
<td>
<ul>
<li><input type="radio" class="input_radio" name="IS_DISPLAY_NEWCOMMENT_HOME" id="is_display_newcomment_home_0" value="1"({if $C_MEMBER_CONFIG.IS_DISPLAY_NEWCOMMENT_HOME}) checked="checked"({/if}) /><label for="is_display_newcomment_home_0">表示する</label></li>
<li><input type="radio" class="input_radio" name="IS_DISPLAY_NEWCOMMENT_HOME" id="is_display_newcomment_home_1" value="0"({if !$C_MEMBER_CONFIG.IS_DISPLAY_NEWCOMMENT_HOME}) checked="checked"({/if}) /><label for="is_display_newcomment_home_1">表示しない</label></li>
</ul>
<p>※マイホームに全体の最新コメントを表示します。</p>
</td>
</tr>

<tr>
<th>({$WORD_MY_FRIEND})最新レビュー</th>
<td>
<ul>
<li><input type="radio" class="input_radio" name="IS_DISPLAY_FRIEND_REVIEW_HOME" id="is_display_friend_review_home_0" value="1"({if $C_MEMBER_CONFIG.IS_DISPLAY_FRIEND_REVIEW_HOME}) checked="checked"({/if}) /><label for="is_display_friend_review_home_0">表示する</label></li>
<li><input type="radio" class="input_radio" name="IS_DISPLAY_FRIEND_REVIEW_HOME" id="is_display_friend_review_home_1" value="0"({if !$C_MEMBER_CONFIG.IS_DISPLAY_FRIEND_REVIEW_HOME}) checked="checked"({/if}) /><label for="is_display_friend_review_home_1">表示しない</label></li>
</ul>
<p>※マイホームに({$WORD_MY_FRIEND})の最新レビューを表示します。</p>
</td>
</tr>

<tr>
<th>({$WORD_MY_FRIEND})最新アルバム</th>
<td>
<ul>
<li><input type="radio" class="input_radio" name="IS_DISPLAY_FRIEND_ALBUM_HOME" id="is_display_friend_album_home_0" value="1"({if $C_MEMBER_CONFIG.IS_DISPLAY_FRIEND_ALBUM_HOME}) checked="checked"({/if}) /><label for="is_display_friend_album_home_0">表示する</label></li>
<li><input type="radio" class="input_radio" name="IS_DISPLAY_FRIEND_ALBUM_HOME" id="is_display_friend_album_home_1" value="0"({if !$C_MEMBER_CONFIG.IS_DISPLAY_FRIEND_ALBUM_HOME}) checked="checked"({/if}) /><label for="is_display_friend_album_home_1">表示しない</label></li>
</ul>
<p>※マイホームに({$WORD_MY_FRIEND})の最新アルバムを表示します。</p>
</td>
</tr>

<tr>
<th>({$WORD_MY_FRIEND})最新blog</th>
<td>
<ul>
<li><input type="radio" class="input_radio" name="IS_DISPLAY_FRIEND_BLOG_HOME" id="is_display_friend_blog_home_0" value="1"({if $C_MEMBER_CONFIG.IS_DISPLAY_FRIEND_BLOG_HOME}) checked="checked"({/if}) /><label for="is_display_friend_blog_home_0">表示する</label></li>
<li><input type="radio" class="input_radio" name="IS_DISPLAY_FRIEND_BLOG_HOME" id="is_display_friend_blog_home_1" value="0"({if !$C_MEMBER_CONFIG.IS_DISPLAY_FRIEND_BLOG_HOME}) checked="checked"({/if}) /><label for="is_display_friend_blog_home_1">表示しない</label></li>
</ul>
