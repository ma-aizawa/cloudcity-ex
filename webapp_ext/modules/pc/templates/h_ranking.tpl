...
<div class="item">
<div class="partsHeading"><h3>ポイント数No１</h3></div>
<p>ポイントが多いメンバーのランキングです。</p>
<p class="link"><a href="({t_url m=pc a=page_h_ranking})&amp;kind=point">ポイント数No１</a></p>
</div>
</div>
({* }}} *})
...
は
({if $kind == "ashiato" || $kind == "friend" || $kind == "point"})
...
<table>
<tr><td class="photo" rowspan="({if $kind == "ashiato" || $kind == "friend" || $kind == "point"})2({else})4({/if})">({strip})
({if $kind == "ashiato" || $kind == "friend" || $kind == "point"})
